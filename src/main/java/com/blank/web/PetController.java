...
public class PetController {
	...
	public String processCreationForm(Pet pet, BindingResult result, SessionStatus status) {
		if (result.hasErrors()) {
			return "pets/petForm";
		} else {
	...
	public String processUpdateForm(Pet pet, BindingResult result, SessionStatus status) {
		if (result.hasErrors()) {
			return "pets/petForm";
		} else {
			this.clinicService.savePet(pet);
